...
class TestFocusMetrics(unittest.TestCase):
    def test_brenner_overflow_handling(self):
        ...
        self.assertGreater(expected_total, 2**31, "The test case itself should exceed int32 limits.")
        ...
        self.assertEqual(actual_score, expected_total, f"Score mismatch! Likely overflow. Expected {expected_total}, got {actual_score}")
