...
| `downsample_factor` | `1` | Read pyramid level (1 = 60× magnification; reads 224 px at native resolution) |
...
5. **Focus scoring** — for each candidate patch, read the full Z-stack (native `224×224`) and compute a Variance of Laplacian focus score for every Z-slice.
